...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, sizeof(::Protocol::ObjectInfo)},
        {11, sizeof(::Protocol::PositionInfo)},
};
...
ObjectInfo::_table_ = {
  {
    ...
    // uint32 health = 3;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(ObjectInfo, _impl_.health_), 3>(),
     {24, 3, 0,
    ...
    // uint32 health = 3;
    {PROTOBUF_FIELD_OFFSET(ObjectInfo, _impl_.health_), _Internal::kHasBitsOffset + 3, 0, (0 | ::_fl::kFcOptional | ::_fl::kUInt32)},
    // .Protocol.PositionInfo posInfo = 4;
...
::uint8_t* PROTOBUF_NONNULL ObjectInfo::_InternalSerialize(
  ...
  if (CheckHasBit(cached_has_bits, 0x00000002U)) {
    target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
        4, *this_._impl_.posinfo_, this_._impl_.posinfo_->GetCachedSize(), target,
        stream);
  }
...
PositionInfo::_table_ = {
  {
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(PositionInfo, _impl_.movedir_), 2>(),
     {24, 2, 0,
    ...
    // float posX = 1;
    {PROTOBUF_FIELD_OFFSET(PositionInfo, _impl_.posx_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kFloat)},
    // float posY = 2;
    {PROTOBUF_FIELD_OFFSET(PositionInfo, _impl_.posy_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kFloat)},
    // .Protocol.MoveDir moveDir = 3;
    {PROTOBUF_FIELD_OFFSET(PositionInfo, _impl_.movedir_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kOpenEnum)},
  }},
  // no aux_entries
  {{
  }},
...
::uint8_t* PROTOBUF_NONNULL PositionInfo::_InternalSerialize(
  ...
  // .Protocol.MoveDir moveDir = 3;
  if (CheckHasBit(cached_has_bits, 0x00000004U)) {
    if (this_._internal_movedir() != 0) {
      target = stream->EnsureSpace(target);
      target = ::_pbi::WireFormatLite::WriteEnumToArray(
          3, this_._internal_movedir(), target);
    }
  }
...
::size_t PositionInfo::ByteSizeLong() const {
  ...
  if (BatchCheckHasBit(cached_has_bits, 0x00000007U)) {
    ...
    if (CheckHasBit(cached_has_bits, 0x00000004U)) {
      if (this_._internal_movedir() != 0) {
        total_size += 1 +
                      ::_pbi::WireFormatLite::EnumSize(this_._internal_movedir());
      }
    }
  }
  return this_.MaybeComputeUnknownFieldsSize(total_size,
